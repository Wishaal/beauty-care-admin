  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        @can('currency-list')
        <li class="nav-item">
          <a class="nav-link" href="{!! route('service-payments.index') !!}"><i class="fa fa-list mr-2"></i>Payments</a>
        </li>
        @endcan
        @can('currency-create')
        <li class="nav-item">
    ...
    <div class="card-body">
        ...
        @endif
      {!! Form::model($servicePayment, ['route' => ['service-payments.update', $servicePayment->id], 'method' => 'patch']) !!}
      <div class="row">
        @include('service_payments.editfields')
    ...
    <script type="text/javascript">
        ...
        function sumServices(){
            ...
            $('.totalprice').each(function(){
                ...
                var bedrag = parseFloat(string[0]);
        ...
        $("#add").click(function () {
            ...
            $('#service_id_'+ i).val(null).trigger("change");
        ...
        $("#addProducts").click(function () {
            ...
            $('#product_id_'+ iP).val(null).trigger("change");
